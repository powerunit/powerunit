...
public interface FunctionTesterStartDSL<T, R> {
	 ...
	 * @return the {@link FunctionTesterDefineDSL the next step of the DSL}
	 */
	 ...
	 * 
	 * @param input
	 *            a supplier to provide the argument to be passed.
	 * @return the {@link FunctionTesterDefineDSL the next step of the DSL}
	 */
	FunctionTesterDefineDSL<T, R> passingAsParameter(Supplier<T> input);
}
