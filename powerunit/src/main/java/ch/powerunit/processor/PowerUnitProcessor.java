...
public class PowerUnitProcessor extends AbstractProcessor implements
	...
	private void generateCategorySuite(RoundEnvironment roundEnv)
		...
		try (PrintWriter w = new PrintWriter(suite.openWriter());) {
			...
			w.println("public final class Suites implements ch.powerunit.TestResultListener {");
			w.println();
			...
			w.println("  static {");
			w.println("    try {");
			w.println("      context = javax.xml.bind.JAXBContext.newInstance(ch.powerunit.report.Testsuites.class);");
			...
			w.println();
			w.println("  private java.util.Map<String,ch.powerunit.report.Testsuite> result = new java.util.HashMap<>();");
			w.println();
			...
			w.println("    result.put(setName, new ch.powerunit.report.Testsuite());");
			...
			w.println();
			w.println("  @Override");
			w.println("  public void notifyStart(ch.powerunit.TestContext context) {");
			w.println("    System.out.println(\"Start of \"+context.getFullTestName());");
			w.println("  }");
			w.println();
			w.println("  @Override");
			w.println("  public void notifySuccess(ch.powerunit.TestContext context) {");
			...
			w.println("    result.get(context.getSetName()).getTestcase().add(new ch.powerunit.report.Testcase());");
			...
			w.println();
			w.println("  @Override");
			w.println("  public void notifyFailure(ch.powerunit.TestContext context, Throwable cause) {");
			...
			w.println("    result.get(context.getSetName()).getTestcase().get(result.get(context.getSetName()).getTestcase().size()-1).setName(context.getLocalTestName()+(context.getParameterName()==null?\"\":(\"[\"+context.getParameterName()+\"]\")));");
			w.println("    result.get(context.getSetName()).getTestcase().get(result.get(context.getSetName()).getTestcase().size()-1).setClassname(context.getTestSuiteObject().getClass().getCanonicalName());");
			w.println("    result.get(context.getSetName()).getTestcase().get(result.get(context.getSetName()).getTestcase().size()-1).getFailure().add(new ch.powerunit.report.Failure());");
			...
			w.println();
			w.println("  @Override");
			w.println("  public void notifySkipped(ch.powerunit.TestContext context) {");
			...
			w.println();
			w.println("  @Override");
			w.println("  public void notifyError(ch.powerunit.TestContext context, Throwable cause) {");
			...
			w.println("    result.get(context.getSetName()).getTestcase().get(result.get(context.getSetName()).getTestcase().size()-1).setName(context.getLocalTestName()+(context.getParameterName()==null?\"\":(\"[\"+context.getParameterName()+\"]\")));");
			w.println("    result.get(context.getSetName()).getTestcase().get(result.get(context.getSetName()).getTestcase().size()-1).setClassname(context.getTestSuiteObject().getClass().getCanonicalName());");
			w.println("    result.get(context.getSetName()).getTestcase().get(result.get(context.getSetName()).getTestcase().size()-1).getError().add(new ch.powerunit.report.Error());");
